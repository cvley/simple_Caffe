...
ConvolutionLayer<Dtype>* GetConvolutionLayer(const std::string& name,
...
template ConvolutionLayer<float>* GetConvolutionLayer(const std::string& name,
    const LayerParameter& param);
template ConvolutionLayer<double>* GetConvolutionLayer(const std::string& name,
    const LayerParameter& param);

// Get pooling layer according to engine.
template <typename Dtype>
PoolingLayer<Dtype>* GetPoolingLayer(const std::string& name,
    const LayerParameter& param) {
...
template PoolingLayer<float>* GetPoolingLayer(const std::string& name,
    const LayerParameter& param);
template PoolingLayer<double>* GetPoolingLayer(const std::string& name,
    const LayerParameter& param);

// Get relu layer according to engine.
template <typename Dtype>
ReLULayer<Dtype>* GetReLULayer(const std::string& name,
    const LayerParameter& param) {
...
template ReLULayer<float>* GetReLULayer(const std::string& name,
    const LayerParameter& param);
template ReLULayer<double>* GetReLULayer(const std::string& name,
    const LayerParameter& param);

// Get sigmoid layer according to engine.
template <typename Dtype>
SigmoidLayer<Dtype>* GetSigmoidLayer(const std::string& name,
    const LayerParameter& param) {
...
template SigmoidLayer<float>* GetSigmoidLayer(const std::string& name,
    const LayerParameter& param);
template SigmoidLayer<double>* GetSigmoidLayer(const std::string& name,
    const LayerParameter& param);

// Get tanh layer according to engine.
template <typename Dtype>
TanHLayer<Dtype>* GetTanHLayer(const std::string& name,
    const LayerParameter& param) {
...
template TanHLayer<float>* GetTanHLayer(const std::string& name,
    const LayerParameter& param);
template TanHLayer<double>* GetTanHLayer(const std::string& name,
    const LayerParameter& param);

// Get softmax layer according to engine.
template <typename Dtype>
SoftmaxLayer<Dtype>* GetSoftmaxLayer(const std::string& name,
    const LayerParameter& param) {
...
template SoftmaxLayer<float>* GetSoftmaxLayer(const std::string& name,
    const LayerParameter& param);
template SoftmaxLayer<double>* GetSoftmaxLayer(const std::string& name,
    const LayerParameter& param);
